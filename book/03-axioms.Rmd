...
We can make use of the three axioms to build more sophisticated statements. For instance:
...
&=& {1} \slash{36} + {1} \slash{36} + {1} \slash{36} + {1} \slash{36}  \\
&=& {4} \slash{36}  \\
&=& 1  \slash{9}. 
\end{eqnarray}
...
```{r ,echo = FALSE, fig.cap=''}
  knitr::include_graphics("img/03_axioms/Ross_Ex.png")
```
