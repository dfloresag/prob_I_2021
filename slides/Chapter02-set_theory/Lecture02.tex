...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth,height=0.6\textheight]{img/Venn1.pdf}
\end{figure}
\end{frame}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth,height=0.7\textheight]{img/Venn2.pdf}
\end{figure}
\end{frame}
...
\begin{figure}[h!]
\centering
\includegraphics[width=1\textwidth,height=0.7\textheight]{img/Venn3.pdf}
\end{figure}
\end{frame}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.8\textwidth,height=0.5\textheight]{img/Venn6.pdf}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.9\textwidth,height=0.6\textheight]{img/Example2.pdf}
\end{figure}
