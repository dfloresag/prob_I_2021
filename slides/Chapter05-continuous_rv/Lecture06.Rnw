...
sp_data %>%
  ggplot() +
  geom_line(aes(x = day ,y =  value), color = "deeppink3") +
  theme_minimal() +
  labs(title = "Daily Returns of the S&P 500 index between 1990 - 1999",
       y = "Returns", x = "Day")
@
  % \begin{figure}[ptb]\centering
  % \includegraphics[width=0.5\textwidth,height=0.5\textheight]{img/R1.pdf}
  % \end{figure}
  \end{example}
\end{frame}
...
sp_data %>%
  ...
  ggplot() +
  geom_col(aes(x =  value, y =relative_frequency), color = "deeppink3") +
  theme_minimal() +
  labs(title = "Relative frequency of returns of the S&P 500 index", y = "Relative frequency", x = "Returns")
@
  \begin{itemize}
...
sp_data %>%
  ggplot() +
  geom_histogram(aes(x =  value), bins = 30, fill = "deeppink3") +
  theme_minimal() +
...
sp_data %>%
  ggplot() +
  geom_histogram(aes(x =  value), bins = 300, fill = "deeppink3") +
  theme_minimal() +
  labs(title = "Histogram returns of the S&P 500 index",
       subtitle="300 bins",
       y = "Frequency", x = "Returns")
...
sp_data %>%
  ggplot() +
  geom_density(aes(x =  value), fill = "deeppink3") +
  theme_minimal() +
  labs(title = "Density Plot: returns of the S&P 500 index",
       y = "Frequency", x = "Returns")
@
  % \begin{figure}[ptb]\centering
  % \includegraphics[width=0.65\textwidth,height=0.55\textheight]{img/R3_ks.pdf}
  % \end{figure}
...
%
%\begin{centering}
%\includegraphics[width=0.5\textwidth,height=0.5\textheight]{img/hist4.pdf}
%\end{centering}
%\end{frame}
%
...
\begin{figure}[ptb]\centering
\includegraphics[width=0.95\textwidth,height=0.75\textheight]{img/generic_CDF2.pdf}%
\end{figure}
\end{frame}%
...
\begin{frame}{\secname}
  \begin{figure}[ptb]\centering
  \includegraphics[scale = 0.4]{img/Diego_F.pdf}%
  \end{figure}%
\end{frame}
...
%
%\begin{figure}[ptb]\centering
%\includegraphics[natheight=7.389in, natwidth=13.4859in, height=2.4031in, width=4.7426in]{img/RU_Normal.pdf}%
%\end{figure}
%
%
%\end{frame}%
